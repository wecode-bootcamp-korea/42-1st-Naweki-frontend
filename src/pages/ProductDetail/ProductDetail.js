...
function ProductDetail() {
  return (
    <div className="productDetail">
      ...
      <div className="size">
        <div className="sizeTwenty">220</div>
        <div className="sizeThirty">230</div>
        <div className="sizeForty">240</div>
        <div className="sizeFifty">250</div>
        <div className="sizeSixty">260</div>
      </div>
